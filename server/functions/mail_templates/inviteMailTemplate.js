module.exports = (name, full_name, start_date, end_date) => {
  return `<!DOCTYPE HTML
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">Hi
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 40px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;">You've
                                                                    been invited to join our
                                                                    <strong>${name}&nbsp;</strong>It will be held from
                                                                    <strong>${start_date}
                                                                    </strong>to&nbsp;<strong>${end_date}.&nbsp;</strong>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div align="center">
                                                                ...
                                                                <a href="http://localhost:3006/auth/signup"
                                                                    target="_blank"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:10px 20px;line-height:120%;"><span
                                                                            style="font-size: 14px; line-height: 16.8px;">Sign
                                                                            Up</span></span>
                                                                </a>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;">Rohan
                                                                    Pawar</p>
                                                                <p style="font-size: 14px; line-height: 140%;">Human
                                                                    Resource Manager,</p>
                                                                <p style="font-size: 14px; line-height: 140%;">
                                                                    Helixstack Technologies LLP</p>
                                                            </div>
